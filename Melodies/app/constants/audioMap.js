...
export const audioMap = {
  ...
  rollinginthedeep: require("../../assets/audio/adele/rolling in the deep/rolling in the deep.mp3"),
  someonelikeyou: require("../../assets/audio/adele/some one like you/some one like you.mp3"),
  rumourhasit: require("../../assets/audio/adele/rumour has it/rumour has it.mp3"),
  turningtables: require("../../assets/audio/adele/Turning Tables/Turning Tables.mp3"),
  dontyouremember: require("../../assets/audio/adele/Dont't  You Remmember/Don't You Remember.mp3"),
  setfiretotherain: require("../../assets/audio/adele/Set Fire to the Rain/Set Fire to the Rain.mp3"),
  hewontgo: require("../../assets/audio/adele/He Won't Go/He Won't Go.mp3"),
  illbewaiting: require("../../assets/audio/adele/I'll Be Waiting/I'll Be Waiting.mp3"),
  oneandonly: require("../../assets/audio/adele/One and Only/One and Only.mp3"),
  lovesong: require("../../assets/audio/adele/Love Song/Love Song.mp3"),
  takeitall: require("../../assets/audio/adele/Take It All/Take It All.mp3"),
